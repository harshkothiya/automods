...
add_action( 'customize_register', 'dactor_customize_register' );
function dactor_customize_register( $wp_customize ) {
	
	//$wp_customize->get_section( 'header_image' )->panel = 'dactor_header_panel';
	...
	$wp_customize->add_panel( 'header_top_panel', array(
		'title' => __( 'Header Top Section', 'dactor' ),
		'description' => __( 'Change the font size and color for Site Title, Site Tagline and Menu', 'dactor' ), // Include html tags such as <p>.
		'priority' => 1, // Mixed with top-level-section hierarchy.
		) );
		
		//Site Title section
		$wp_customize->add_section( 'site_title_section', array(
			'title' => __( 'Site Title' , 'dactor' ),
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'site_title_color', array(
					...
					'label' => __( 'Color', 'dactor' ),
					'description' => __( 'Change color of site title', 'dactor' ),
					) )
				);
		
		//Site Tagline section
		$wp_customize->add_section( 'site_tagline_section', array(
			'title' => __( 'Site Tagline' , 'dactor' ),
			'panel' => 'header_top_panel',
			'priority' => 2,
			'capability' => 'edit_theme_options',
			) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'tagline_color', array(
					...
					'label' => __( 'Color', 'dactor' ),
					'description' => __( 'Change color of site tagline', 'dactor' ),
					) ) );
			
	/*--- Header Banner ---*/
	$wp_customize->add_panel( 'header_banner', array(
		'title' => __( 'Header Banner', 'dactor' ),
		'description' => __( 'Change the font size and color for Site Title, Site Tagline and Menu', 'dactor' ),
		'priority' => 2,
		) );
	
		//Banner type section
		$wp_customize->add_section( 'banner_type_section', array(
			'title' => __( 'Banner Type' , 'dactor' ),
			'panel' => 'header_banner',
			'priority' => 1,
			'capability' => 'edit_theme_options',
			) );
			...
			$wp_customize->add_control( 'banner_type', array(
				...
				'label' => __( 'Fron page banner type', 'dactor' ),
				'description' => __( 'Select banner type for front page', 'dactor' ),
				'choices' => array(
					'bg-color' => __( 'Background Color', 'dactor' ),
					'bg-gradient' => __( 'Background Gradient', 'dactor' ),
					'image' => __( 'Background Image', 'dactor' ),
					'video' => __( 'Background Video', 'dactor' ),
				),
				) );
			...
			$wp_customize->add_control( 'banner_height', array(
				...
				'label' => __( 'Height of banner (Default: 700px)', 'dactor' ),
				'input_attrs' => array(
					'min' => 0,
					'max' => 2000,
					'step' => 1,
		...
		$wp_customize->add_section( 'banner_bg_color_section', array(
			'title' => __( 'Banner Background: Color' , 'dactor' ),
			'panel' => 'header_banner',
			'priority' => 2,
			'capability' => 'edit_theme_options',
			) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_color', array(
					...
					'label' => __( 'Background Color', 'dactor' ),
					'description' => __( 'Change background color of banner', 'dactor' ),
				) ) );
			
		//Banner background Gradient section
		$wp_customize->add_section( 'banner_bg_gradient_section', array(
			'title' => __( 'Banner Background: Gradient' , 'dactor' ),
			'panel' => 'header_banner',
			'priority' => 3,
			'capability' => 'edit_theme_options',
			'description' => __( 'Choose the colors below to give gradient background to your banner', 'dactor' ),
			) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_gradient_1', array(
					...
					'label' => __( 'Gradient color 1', 'dactor' ),
					'description' => __( 'Add 1st Gradient color', 'dactor' ),
					) ) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_gradient_2', array(
					...
					'label' => __( 'Gradient color 2', 'dactor' ),
					'description' => __( 'Add 2nd Gradient color', 'dactor' ),
					) ) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_gradient_3', array(
					...
					'label' => __( 'Gradient color 3', 'dactor' ),
					'description' => __( 'Add 3rd Gradient color', 'dactor' ),
					) ) );
		
		//Banner background image section
		$wp_customize->add_section( 'banner_bg_img_section', array(
			'title' => __( 'Banner Background: Image' , 'dactor' ),
			'panel' => 'header_banner',
			'priority' => 4,
			'capability' => 'edit_theme_options',
			'description' => __( 'Upload image and set other settings for banner background', 'dactor' ),
			) );
			...
			$wp_customize->add_control( new WP_Customize_Image_Control(
				$wp_customize, 'banner_bg_img', array(
					...
					'label' => __( 'Upload image for background', 'dactor' ),
					) ) );
			...
			$wp_customize->add_control( 'banner_bg_size', array(
				...
				'label' => __( 'Banner background size', 'dactor' ),
				'choices' => array(
					'cover' => __( 'cover', 'dactor' ),
					'contain' => __( 'contain', 'dactor' ),
				),
				) );
			...
			$wp_customize->add_control( 'banner_bg_pos', array(
				...
				'label' => __( 'Banner background position', 'dactor' ),
				'choices' => array(
					'top-left' => __( 'top left', 'dactor' ),
					'top-center' => __( 'top center', 'dactor' ),
					'top-right' => __( 'top right', 'dactor' ),
					'center-left' => __( 'center left', 'dactor' ),
					'center-center' => __( 'center center', 'dactor' ),
					'center-right' => __( 'center right', 'dactor' ),
					'bottom-left' => __( 'bottom left', 'dactor' ),
					'bottom-center' => __( 'bottom center', 'dactor' ),
					'bottom-right' => __( 'bottom right', 'dactor' ),
				),
				) );
			...
			$wp_customize->add_control( 'banner_bg_repeat', array(
				...
				'label' => __( 'Banner background no-repeat', 'dactor' ),
				) );
			
		//Banner content section
		$wp_customize->add_section( 'banner_content_section', array(
			'title' => __( 'Banner content' , 'dactor' ),
			'panel' => 'header_banner',
			'priority' => 5,
			'capability' => 'edit_theme_options',
			'description' => __( 'Form here you can change the text of all titles, subititle and paragraph present on banner', 'dactor' ),
			) );
		
			//Banner main title
			$wp_customize->add_setting( 'banner_main_title', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'Hospital that you can trust', 'dactor' ),
				'transport' => 'refresh',
			...
			$wp_customize->add_control( 'banner_main_title', array(
				...
				'label' => __( 'Banner main title', 'dactor' ),
				) );
			...
			$wp_customize->add_control( 'banner_sub_title', array(
				...
				'label' => __( 'Banner sub title', 'dactor' ),
				) );
			
			//Banner paragraph
			$wp_customize->add_setting( 'banner_para', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'Looking for an Electrician', 'dactor' ),
				'transport' => 'refresh',
				'sanitize_callback' => 'wp_filter_nohtml_kses',
				) );
			...
			$wp_customize->add_control( 'banner_para', array(
				...
				'label' => __( 'Banner paragraph', 'dactor' ),
				) );
			
			//Banner button1 text
			$wp_customize->add_setting( 'banner_btn1_txt', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'Ready to start', 'dactor' ),
				'transport' => 'refresh',
				'sanitize_callback' => 'wp_filter_nohtml_kses',
				) );
			...
			$wp_customize->add_control( 'banner_btn1_txt', array(
				...
				'label' => __( 'Banner 1st button text', 'dactor' ),
				) );
			...
			$wp_customize->add_control( 'banner_btn1_url', array(
				...
				'label' => __( 'Banner 1st button url', 'dactor' ),
				) );
			
			//Banner button2 text
			$wp_customize->add_setting( 'banner_btn2_txt', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'Know More', 'dactor' ),
				'transport' => 'refresh',
				'sanitize_callback' => 'wp_filter_nohtml_kses',
				) );
			...
			$wp_customize->add_control( 'banner_btn2_txt', array(
				...
				'label' => __( 'Banner 2nd button text', 'dactor' ),
				) );
			...
			$wp_customize->add_control( 'banner_btn2_url', array(
				...
				'label' => __( 'Banner 2nd button url', 'dactor' ),
				) );
			...
			$wp_customize->add_control( new WP_Customize_Image_Control(
				$wp_customize, 'banner_side_img', array(
					...
					'label' => __( 'Upload side image for banner', 'dactor' ),
					) ) ); */
				
	
	/*--- General settings ---*/
	$wp_customize->add_panel( 'general_settings', array(
		'title' => __( 'General settings', 'dactor' ),
		'priority' => 3,
		) );
		
		//Page padding section
		$wp_customize->add_section( 'page_padding', array(
			'title' => __( 'Main page padding' , 'dactor' ),
			'panel' => 'general_settings',
			'priority' => 1,
			'capability' => 'edit_theme_options',
			'description' => __( 'Form here you can change the top and bottom padding of page', 'dactor' ),
			) );
			...
			$wp_customize->add_control( 'page_top_padding', array(
				...
				'label' => __( 'Space between header and page content (in px)', 'dactor' ),
				'input_attrs' => array(
					'min' => 0,
					'max' => 500,
					'step' => 1,
			...
			$wp_customize->add_control( 'page_bottom_padding', array(
				...
				'label' => __( 'Space between footer and page content (in px)', 'dactor' ),
				'input_attrs' => array(
					'min' => 0,
					'max' => 500,
					'step' => 1,
	...
	$wp_customize->add_panel( 'theme_blog_panel', array(
		'title' => __( 'Blogs Panel', 'dactor' ),
		'priority' => 4,
		) );
		
		//Blog layout
		$wp_customize->add_section( 'theme_blog_layout', array(
			'title' => __( 'Blog layout' , 'dactor' ),
			...
			$wp_customize->add_control( 'theme_blog_type', array(
				...
				'label' => __( 'Select blog layout', 'dactor' ),
				'description' => __( 'This will change the styling of blogs on blog and single blog page', 'dactor' ),
				'choices' => array(
					'default' => __( 'Default', 'dactor' ),
					'special' => __( 'Special', 'dactor' ),
				),
				) );
			...
			$wp_customize->add_control( 'show_sidebar', array(
				...
				'label' => __( 'Check this box to show sidebar on blogs page', 'dactor' ),
				) );
			...
			$wp_customize->add_control( 'show_sidebar_single', array(
				...
				'label' => __( 'Check this box to show sidebar on single blog page', 'dactor' ),
				) );
	...
	/*--- Colors panel ---*/		
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'primary_color', array(
					...
					'label' => __( 'Primary color', 'dactor' ),
					'description' => __( 'Change in this color will change the primary color of whole theme', 'dactor' ),
					) ) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'theme_text_color', array(
					...
					'label' => __( 'Theme text color', 'dactor' ),
					'description' => __( 'Change in this color will change the text color of whole theme (basically all paragraphs).', 'dactor' ),
					) ) );
					
			// Register upsell
        	$wp_customize->register_section_type( 'Dactor_Upsell' );
        	class Dactor_Upsell extends WP_Customize_Section {
                public $type = 'upsell';
                public $url = '';
        		public $text = '';
        	...
        	$wp_customize->add_section( new Dactor_Upsell( $wp_customize, 'upsell', array(
        		'title' => __('upsell', 'dactor'),
                'text' => 'Pro Features',
                'url' => 'https://suavethemes.com/details/corporate/dactor-pro'
                //'priority' => 0
                ) )
            );				
}
...
function twx_sntz_banner_type( $value ){
	$valid = array(
        'bg-color' => __( 'Color', 'dactor' ),
		'bg-gradient' => __( 'Gradient', 'dactor' ),
		'image' => __( 'Image', 'dactor' ),
		'video' => __( 'Video', 'dactor' ),
		'carousel' => __( 'Background Carousel', 'dactor' ),
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}

function dactor_sanitize_menu( $value ){
	$valid = array(
		'sticky'   => __('Sticky', 'dactor'),
		'static'   => __('Static', 'dactor'),
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}
...
function dactor_sanitize_widget_area($value){
	$valid = array(
		'1'     => __('One', 'dactor'),
		'2'     => __('Two', 'dactor'),
		'3'     => __('Three', 'dactor'),
...
function dactor_sanitize_wc_content($value){
	$valid = array(
		'left'    => __('Left', 'dactor'),
		'right'     => __('Right', 'dactor'),
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}

function dactor_sanitize_image( $input ){
