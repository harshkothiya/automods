 ...
 * Set import files
 */
function dactor_set_import_files() {
    return array(
        array(
            'import_file_name'           => __('Dummy-data', 'dactor'),
            'local_import_file'          => trailingslashit( get_template_directory() ) . 'dummy-data/dummy-data.xml',
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'dactor_set_import_files' );

/**
 * Define actions that happen after import
 */
function dactor_actions_after_import() {
...
add_action( 'pt-ocdi/after_import', 'dactor_actions_after_import' );
