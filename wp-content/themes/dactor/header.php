...
<html <?php language_attributes(); ?>>
  ...
  <body <?php body_class(); ?>>
  	...
  	<?php 
	if ( function_exists( 'dactor_contact_info' ) ) {
		dactor_contact_info(); 
	}?>
	...
	<div class="dactor-banner-area">
		...
		<?php if( is_front_page() ) :
				...
				elseif ( $banner_type == 'carousel' && is_front_page() ) :
					dactor_banner_slider();
				else :
					dactor_banner_background();
				endif;
			else : ?>
			<div class="header-background other-header">
				...
				<div class="header-content other">
					...
					<div class = "breadcrumb" ><?php if (class_exists('WooCommerce')){
							( (is_woocommerce())? woocommerce_breadcrumb() : dactor_get_breadcrumb() );
						}else{
							dactor_get_breadcrumb();
						}?></div>
					<?php endif; ?>
				</div>
			</div>
